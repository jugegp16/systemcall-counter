...
int  main(int argc, char *argv[])
{
  ...
  15:	6a 01                	push   $0x1
  17:	e8 bf 03 00 00       	call   3db <getcount>
  1c:	83 c4 0c             	add    $0xc,%esp
  1f:	50                   	push   %eax
  20:	68 08 08 00 00       	push   $0x808
  25:	6a 01                	push   $0x1
  27:	e8 74 04 00 00       	call   4a0 <printf>
    if (fork() == 0) {
  ...
  74:	6a 03                	push   $0x3
  76:	e8 60 03 00 00       	call   3db <getcount>
  7b:	83 c4 0c             	add    $0xc,%esp
  7e:	50                   	push   %eax
  7f:	68 77 08 00 00       	push   $0x877
  84:	6a 01                	push   $0x1
  ...
  98:	6a 01                	push   $0x1
  9a:	e8 3c 03 00 00       	call   3db <getcount>
  ...
  b6:	e8 20 03 00 00       	call   3db <getcount>
  bb:	83 c4 0c             	add    $0xc,%esp
  be:	50                   	push   %eax
  bf:	68 60 08 00 00       	push   $0x860
  c4:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 86 08 00 00       	mov    $0x886,%ebx
        while(*s != 0){
