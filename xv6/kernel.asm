...
801037df:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e5:	e8 86 0e 00 00       	call   80104670 <release>
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	c7 40 14 0f 59 10 80 	movl   $0x8010590f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103819:	e8 a2 0e 00 00       	call   801046c0 <memset>
...
80103842:	e8 29 0e 00 00       	call   80104670 <release>
}
...
8010387f:	e8 ec 0d 00 00       	call   80104670 <release>
...
801038d4:	e8 57 0b 00 00       	call   80104430 <initlock>
}
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 30 0b 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 70 0b 00 00       	call   80104500 <popcli>
}
...
801039ea:	e8 d1 0c 00 00       	call   801046c0 <memset>
...
80103a49:	e8 32 0e 00 00       	call   80104880 <safestrcpy>
  p->cwd = namei("/");
...
80103aa9:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aac:	e8 ff 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103ab1:	e8 2a fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103ab6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103abc:	e8 3f 0a 00 00       	call   80104500 <popcli>
  sz = curproc->sz;
...
80103b0a:	e8 11 33 00 00       	call   80106e20 <deallocuvm>
...
80103b2a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b2d:	e8 7e 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103b32:	e8 a9 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b37:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b3d:	e8 be 09 00 00       	call   80104500 <popcli>
  if((np = allocproc()) == 0){
80103b42:	e8 49 fc ff ff       	call   80103790 <allocproc>
80103b47:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b4a:	85 c0                	test   %eax,%eax
80103b4c:	0f 84 d3 00 00 00    	je     80103c25 <fork+0x105>
80103b52:	89 c7                	mov    %eax,%edi
80103b54:	8d 40 7c             	lea    0x7c(%eax),%eax
80103b57:	8d 97 d4 00 00 00    	lea    0xd4(%edi),%edx
80103b5d:	8d 76 00             	lea    0x0(%esi),%esi
    np->count[i]=0;
80103b60:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (i=0;i<22;i++){
80103b66:	83 c0 04             	add    $0x4,%eax
80103b69:	39 c2                	cmp    %eax,%edx
80103b6b:	75 f3                	jne    80103b60 <fork+0x40>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103b6d:	83 ec 08             	sub    $0x8,%esp
80103b70:	ff 33                	pushl  (%ebx)
80103b72:	ff 73 04             	pushl  0x4(%ebx)
80103b75:	e8 26 34 00 00       	call   80106fa0 <copyuvm>
80103b7a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b7d:	83 c4 10             	add    $0x10,%esp
80103b80:	89 41 04             	mov    %eax,0x4(%ecx)
80103b83:	85 c0                	test   %eax,%eax
80103b85:	0f 84 a1 00 00 00    	je     80103c2c <fork+0x10c>
  np->sz = curproc->sz;
...
80103bf1:	e8 8a 0c 00 00       	call   80104880 <safestrcpy>
  pid = np->pid;
80103bf6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bf9:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c00:	e8 ab 09 00 00       	call   801045b0 <acquire>
  np->state = RUNNABLE;
...
80103c2f:	ff 71 08             	pushl  0x8(%ecx)
80103c32:	89 cb                	mov    %ecx,%ebx
80103c34:	e8 37 e8 ff ff       	call   80102470 <kfree>
    np->kstack = 0;
80103c39:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
...
80103c4f:	eb ca                	jmp    80103c1b <fork+0xfb>
...
80103cb0:	e8 db 2d 00 00       	call   80106a90 <switchuvm>
...
80103cc2:	e8 1c 0c 00 00       	call   801048e3 <swtch>
      switchkvm();
80103cc7:	e8 a4 2d 00 00       	call   80106a70 <switchkvm>
      c->proc = 0;
...
80103ee7:	68 28 77 10 80       	push   $0x80107728
80103eec:	e8 9f c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103ef1:	83 ec 0c             	sub    $0xc,%esp
80103ef4:	68 1b 77 10 80       	push   $0x8010771b
...
80103ff9:	68 3a 77 10 80       	push   $0x8010773a
80103ffe:	e8 8d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104003:	83 ec 0c             	sub    $0xc,%esp
80104006:	68 34 77 10 80       	push   $0x80107734
...
801040b2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040b9:	e8 92 2d 00 00       	call   80106e50 <freevm>
        release(&ptable.lock);
...
80104233:	68 bb 7a 10 80       	push   $0x80107abb
...
80104257:	74 e7                	je     80104240 <procdump+0x30>
      state = "???";
80104259:	ba 4b 77 10 80       	mov    $0x8010774b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010425e:	83 f8 05             	cmp    $0x5,%eax
80104261:	77 11                	ja     80104274 <procdump+0x64>
80104263:	8b 14 85 ac 77 10 80 	mov    -0x7fef8854(,%eax,4),%edx
      state = "???";
8010426a:	b8 4b 77 10 80       	mov    $0x8010774b,%eax
...
80104279:	68 4f 77 10 80       	push   $0x8010774f
...
801042c1:	68 a1 71 10 80       	push   $0x801071a1
...
8010436b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104371:	e8 fa f5 ff ff       	call   80103970 <myproc>
...
80104413:	e8 58 f5 ff ff       	call   80103970 <myproc>
...
801044df:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801044e0:	e8 fb f3 ff ff       	call   801038e0 <mycpu>
...
8010451f:	e8 bc f3 ff ff       	call   801038e0 <mycpu>
...
8010494b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010494e:	e8 1d f0 ff ff       	call   80103970 <myproc>
...
801049fc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049ff:	e8 6c ef ff ff       	call   80103970 <myproc>
...
80104aac:	77 22                	ja     80104ad0 <syscall+0x40>
80104aae:	8b 04 b5 20 78 10 80 	mov    -0x7fef87e0(,%esi,4),%eax
80104ab5:	85 c0                	test   %eax,%eax
80104ab7:	74 17                	je     80104ad0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104ab9:	ff d0                	call   *%eax
80104abb:	8b 53 18             	mov    0x18(%ebx),%edx
80104abe:	89 42 1c             	mov    %eax,0x1c(%edx)
    curproc->count[num]+=1;
80104ac1:	83 44 b3 7c 01       	addl   $0x1,0x7c(%ebx,%esi,4)
  } else {
...
80104c34:	68 98 78 10 80       	push   $0x80107898
...
80104c4c:	68 97 78 10 80       	push   $0x80107897
...
80104c61:	68 8b 78 10 80       	push   $0x8010788b
...
80104c7f:	68 9a 78 10 80       	push   $0x8010789a
80104c84:	e8 07 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c89:	83 ec 0c             	sub    $0xc,%esp
80104c8c:	68 7c 78 10 80       	push   $0x8010787c
...
80104cc4:	e8 a7 ec ff ff       	call   80103970 <myproc>
...
80104d0d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d0f:	e8 5c ec ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104e57:	78 27                	js     80104e80 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e59:	e8 12 eb ff ff       	call   80103970 <myproc>
...
8010507d:	58                   	pop    %eax
8010507e:	5a                   	pop    %edx
8010507f:	68 98 78 10 80       	push   $0x80107898
...
80105098:	68 97 78 10 80       	push   $0x80107897
...
80105469:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010546c:	e8 ff e4 ff ff       	call   80103970 <myproc>
...
80105697:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010569a:	e8 d1 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056f0:	f3 0f 1e fb          	endbr32 
  return fork();
801056f4:	e9 27 e4 ff ff       	jmp    80103b20 <fork>
...
801057ab:	78 23                	js     801057d0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057ad:	e8 be e1 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
801057ba:	e8 e1 e2 ff ff       	call   80103aa0 <growproc>
...
80105937:	c7 04 c5 a2 62 11 80 	movl   $0x8e000008,-0x7fee9d5e(,%eax,8)
8010593e:	08 00 00 8e 
80105942:	66 89 14 c5 a0 62 11 	mov    %dx,-0x7fee9d60(,%eax,8)
80105949:	80 
8010594a:	c1 ea 10             	shr    $0x10,%edx
8010594d:	66 89 14 c5 a6 62 11 	mov    %dx,-0x7fee9d5a(,%eax,8)
80105954:	80 
  for(i = 0; i < 256; i++)
...
80105967:	c7 05 a2 64 11 80 08 	movl   $0xef000008,0x801164a2
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 dd 78 10 80       	push   $0x801078dd
80105976:	68 60 62 11 80       	push   $0x80116260
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010597b:	66 a3 a0 64 11 80    	mov    %ax,0x801164a0
80105981:	c1 e8 10             	shr    $0x10,%eax
80105984:	66 a3 a6 64 11 80    	mov    %ax,0x801164a6
  initlock(&tickslock, "time");
8010598a:	e8 a1 ea ff ff       	call   80104430 <initlock>
}
...
801059af:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059b3:	b8 a0 62 11 80       	mov    $0x801162a0,%eax
...
80105af7:	68 60 62 11 80       	push   $0x80116260
80105afc:	e8 af ea ff ff       	call   801045b0 <acquire>
      wakeup(&ticks);
80105b01:	c7 04 24 a0 6a 11 80 	movl   $0x80116aa0,(%esp)
      ticks++;
80105b08:	83 05 a0 6a 11 80 01 	addl   $0x1,0x80116aa0
      wakeup(&ticks);
80105b0f:	e8 fc e5 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105b14:	c7 04 24 60 62 11 80 	movl   $0x80116260,(%esp)
80105b1b:	e8 50 eb ff ff       	call   80104670 <release>
...
80105b94:	0f 85 0e ff ff ff    	jne    80105aa8 <trap+0xd8>
    yield();
80105b9a:	e8 61 e3 ff ff       	call   80103f00 <yield>
...
80105bb9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bbc:	e8 cf ee ff ff       	call   80104a90 <syscall>
    if(myproc()->killed)
...
80105bd7:	5d                   	pop    %ebp
      exit();
80105bd8:	e9 e3 e1 ff ff       	jmp    80103dc0 <exit>
80105bdd:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105be0:	e8 db e1 ff ff       	call   80103dc0 <exit>
80105be5:	e9 a6 fe ff ff       	jmp    80105a90 <trap+0xc0>
80105bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bf0:	e8 cb e1 ff ff       	call   80103dc0 <exit>
...
80105dab:	6a 00                	push   $0x0
  jmp alltraps
80105dad:	e9 45 fb ff ff       	jmp    801058f7 <alltraps>
...
80105db4:	6a 01                	push   $0x1
  jmp alltraps
80105db6:	e9 3c fb ff ff       	jmp    801058f7 <alltraps>
...
80105dbd:	6a 02                	push   $0x2
  jmp alltraps
80105dbf:	e9 33 fb ff ff       	jmp    801058f7 <alltraps>
...
80105dc6:	6a 03                	push   $0x3
  jmp alltraps
80105dc8:	e9 2a fb ff ff       	jmp    801058f7 <alltraps>
...
80105dcf:	6a 04                	push   $0x4
  jmp alltraps
80105dd1:	e9 21 fb ff ff       	jmp    801058f7 <alltraps>
...
80105dd8:	6a 05                	push   $0x5
  jmp alltraps
80105dda:	e9 18 fb ff ff       	jmp    801058f7 <alltraps>
...
80105de1:	6a 06                	push   $0x6
  jmp alltraps
80105de3:	e9 0f fb ff ff       	jmp    801058f7 <alltraps>
...
80105dea:	6a 07                	push   $0x7
  jmp alltraps
80105dec:	e9 06 fb ff ff       	jmp    801058f7 <alltraps>
...
80105df1:	6a 08                	push   $0x8
  jmp alltraps
80105df3:	e9 ff fa ff ff       	jmp    801058f7 <alltraps>
...
80105e0f:	6a 0c                	push   $0xc
  jmp alltraps
80105e11:	e9 e1 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e2f:	6a 10                	push   $0x10
  jmp alltraps
80105e31:	e9 c1 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e3f:	6a 12                	push   $0x12
  jmp alltraps
80105e41:	e9 b1 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e48:	6a 13                	push   $0x13
  jmp alltraps
80105e4a:	e9 a8 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e51:	6a 14                	push   $0x14
  jmp alltraps
80105e53:	e9 9f fa ff ff       	jmp    801058f7 <alltraps>
...
80105e5a:	6a 15                	push   $0x15
  jmp alltraps
80105e5c:	e9 96 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e63:	6a 16                	push   $0x16
  jmp alltraps
80105e65:	e9 8d fa ff ff       	jmp    801058f7 <alltraps>
...
80105e6c:	6a 17                	push   $0x17
  jmp alltraps
80105e6e:	e9 84 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e75:	6a 18                	push   $0x18
  jmp alltraps
80105e77:	e9 7b fa ff ff       	jmp    801058f7 <alltraps>
...
80105e7e:	6a 19                	push   $0x19
  jmp alltraps
80105e80:	e9 72 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e87:	6a 1a                	push   $0x1a
  jmp alltraps
80105e89:	e9 69 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e90:	6a 1b                	push   $0x1b
  jmp alltraps
80105e92:	e9 60 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e99:	6a 1c                	push   $0x1c
  jmp alltraps
80105e9b:	e9 57 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ea2:	6a 1d                	push   $0x1d
  jmp alltraps
80105ea4:	e9 4e fa ff ff       	jmp    801058f7 <alltraps>
...
80105eab:	6a 1e                	push   $0x1e
  jmp alltraps
80105ead:	e9 45 fa ff ff       	jmp    801058f7 <alltraps>
...
80105eb4:	6a 1f                	push   $0x1f
  jmp alltraps
80105eb6:	e9 3c fa ff ff       	jmp    801058f7 <alltraps>
...
80105ebd:	6a 20                	push   $0x20
  jmp alltraps
80105ebf:	e9 33 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ec6:	6a 21                	push   $0x21
  jmp alltraps
80105ec8:	e9 2a fa ff ff       	jmp    801058f7 <alltraps>
...
80105ecf:	6a 22                	push   $0x22
  jmp alltraps
80105ed1:	e9 21 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ed8:	6a 23                	push   $0x23
  jmp alltraps
80105eda:	e9 18 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ee1:	6a 24                	push   $0x24
  jmp alltraps
80105ee3:	e9 0f fa ff ff       	jmp    801058f7 <alltraps>
...
80105eea:	6a 25                	push   $0x25
  jmp alltraps
80105eec:	e9 06 fa ff ff       	jmp    801058f7 <alltraps>
...
80105ef3:	6a 26                	push   $0x26
  jmp alltraps
80105ef5:	e9 fd f9 ff ff       	jmp    801058f7 <alltraps>
...
80105efc:	6a 27                	push   $0x27
  jmp alltraps
80105efe:	e9 f4 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f05:	6a 28                	push   $0x28
  jmp alltraps
80105f07:	e9 eb f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f0e:	6a 29                	push   $0x29
  jmp alltraps
80105f10:	e9 e2 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f17:	6a 2a                	push   $0x2a
  jmp alltraps
80105f19:	e9 d9 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f20:	6a 2b                	push   $0x2b
  jmp alltraps
80105f22:	e9 d0 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f29:	6a 2c                	push   $0x2c
  jmp alltraps
80105f2b:	e9 c7 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f32:	6a 2d                	push   $0x2d
  jmp alltraps
80105f34:	e9 be f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f3b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f3d:	e9 b5 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f44:	6a 2f                	push   $0x2f
  jmp alltraps
80105f46:	e9 ac f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f4d:	6a 30                	push   $0x30
  jmp alltraps
80105f4f:	e9 a3 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f56:	6a 31                	push   $0x31
  jmp alltraps
80105f58:	e9 9a f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f5f:	6a 32                	push   $0x32
  jmp alltraps
80105f61:	e9 91 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f68:	6a 33                	push   $0x33
  jmp alltraps
80105f6a:	e9 88 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f71:	6a 34                	push   $0x34
  jmp alltraps
80105f73:	e9 7f f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f7a:	6a 35                	push   $0x35
  jmp alltraps
80105f7c:	e9 76 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f83:	6a 36                	push   $0x36
  jmp alltraps
80105f85:	e9 6d f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f8c:	6a 37                	push   $0x37
  jmp alltraps
80105f8e:	e9 64 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f95:	6a 38                	push   $0x38
  jmp alltraps
80105f97:	e9 5b f9 ff ff       	jmp    801058f7 <alltraps>
...
80105f9e:	6a 39                	push   $0x39
  jmp alltraps
80105fa0:	e9 52 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fa7:	6a 3a                	push   $0x3a
  jmp alltraps
80105fa9:	e9 49 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fb0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fb2:	e9 40 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fb9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fbb:	e9 37 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fc2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fc4:	e9 2e f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fcb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fcd:	e9 25 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fd4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fd6:	e9 1c f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fdd:	6a 40                	push   $0x40
  jmp alltraps
80105fdf:	e9 13 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fe6:	6a 41                	push   $0x41
  jmp alltraps
80105fe8:	e9 0a f9 ff ff       	jmp    801058f7 <alltraps>
...
80105fef:	6a 42                	push   $0x42
  jmp alltraps
80105ff1:	e9 01 f9 ff ff       	jmp    801058f7 <alltraps>
...
80105ff8:	6a 43                	push   $0x43
  jmp alltraps
80105ffa:	e9 f8 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106001:	6a 44                	push   $0x44
  jmp alltraps
80106003:	e9 ef f8 ff ff       	jmp    801058f7 <alltraps>
...
8010600a:	6a 45                	push   $0x45
  jmp alltraps
8010600c:	e9 e6 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106013:	6a 46                	push   $0x46
  jmp alltraps
80106015:	e9 dd f8 ff ff       	jmp    801058f7 <alltraps>
...
8010601c:	6a 47                	push   $0x47
  jmp alltraps
8010601e:	e9 d4 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106025:	6a 48                	push   $0x48
  jmp alltraps
80106027:	e9 cb f8 ff ff       	jmp    801058f7 <alltraps>
...
8010602e:	6a 49                	push   $0x49
  jmp alltraps
80106030:	e9 c2 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106037:	6a 4a                	push   $0x4a
  jmp alltraps
80106039:	e9 b9 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106040:	6a 4b                	push   $0x4b
  jmp alltraps
80106042:	e9 b0 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106049:	6a 4c                	push   $0x4c
  jmp alltraps
8010604b:	e9 a7 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106052:	6a 4d                	push   $0x4d
  jmp alltraps
80106054:	e9 9e f8 ff ff       	jmp    801058f7 <alltraps>
...
8010605b:	6a 4e                	push   $0x4e
  jmp alltraps
8010605d:	e9 95 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106064:	6a 4f                	push   $0x4f
  jmp alltraps
80106066:	e9 8c f8 ff ff       	jmp    801058f7 <alltraps>
...
8010606d:	6a 50                	push   $0x50
  jmp alltraps
8010606f:	e9 83 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106076:	6a 51                	push   $0x51
  jmp alltraps
80106078:	e9 7a f8 ff ff       	jmp    801058f7 <alltraps>
...
8010607f:	6a 52                	push   $0x52
  jmp alltraps
80106081:	e9 71 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106088:	6a 53                	push   $0x53
  jmp alltraps
8010608a:	e9 68 f8 ff ff       	jmp    801058f7 <alltraps>
...
80106091:	6a 54                	push   $0x54
  jmp alltraps
80106093:	e9 5f f8 ff ff       	jmp    801058f7 <alltraps>
...
8010609a:	6a 55                	push   $0x55
  jmp alltraps
8010609c:	e9 56 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060a3:	6a 56                	push   $0x56
  jmp alltraps
801060a5:	e9 4d f8 ff ff       	jmp    801058f7 <alltraps>
...
801060ac:	6a 57                	push   $0x57
  jmp alltraps
801060ae:	e9 44 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060b5:	6a 58                	push   $0x58
  jmp alltraps
801060b7:	e9 3b f8 ff ff       	jmp    801058f7 <alltraps>
...
801060be:	6a 59                	push   $0x59
  jmp alltraps
801060c0:	e9 32 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060c7:	6a 5a                	push   $0x5a
  jmp alltraps
801060c9:	e9 29 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060d0:	6a 5b                	push   $0x5b
  jmp alltraps
801060d2:	e9 20 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060d9:	6a 5c                	push   $0x5c
  jmp alltraps
801060db:	e9 17 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060e2:	6a 5d                	push   $0x5d
  jmp alltraps
801060e4:	e9 0e f8 ff ff       	jmp    801058f7 <alltraps>
...
801060eb:	6a 5e                	push   $0x5e
  jmp alltraps
801060ed:	e9 05 f8 ff ff       	jmp    801058f7 <alltraps>
...
801060f4:	6a 5f                	push   $0x5f
  jmp alltraps
801060f6:	e9 fc f7 ff ff       	jmp    801058f7 <alltraps>
...
801060fd:	6a 60                	push   $0x60
  jmp alltraps
801060ff:	e9 f3 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106106:	6a 61                	push   $0x61
  jmp alltraps
80106108:	e9 ea f7 ff ff       	jmp    801058f7 <alltraps>
...
8010610f:	6a 62                	push   $0x62
  jmp alltraps
80106111:	e9 e1 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106118:	6a 63                	push   $0x63
  jmp alltraps
8010611a:	e9 d8 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106121:	6a 64                	push   $0x64
  jmp alltraps
80106123:	e9 cf f7 ff ff       	jmp    801058f7 <alltraps>
...
8010612a:	6a 65                	push   $0x65
  jmp alltraps
8010612c:	e9 c6 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106133:	6a 66                	push   $0x66
  jmp alltraps
80106135:	e9 bd f7 ff ff       	jmp    801058f7 <alltraps>
...
8010613c:	6a 67                	push   $0x67
  jmp alltraps
8010613e:	e9 b4 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106145:	6a 68                	push   $0x68
  jmp alltraps
80106147:	e9 ab f7 ff ff       	jmp    801058f7 <alltraps>
...
8010614e:	6a 69                	push   $0x69
  jmp alltraps
80106150:	e9 a2 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106157:	6a 6a                	push   $0x6a
  jmp alltraps
80106159:	e9 99 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106160:	6a 6b                	push   $0x6b
  jmp alltraps
80106162:	e9 90 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106169:	6a 6c                	push   $0x6c
  jmp alltraps
8010616b:	e9 87 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106172:	6a 6d                	push   $0x6d
  jmp alltraps
80106174:	e9 7e f7 ff ff       	jmp    801058f7 <alltraps>
...
8010617b:	6a 6e                	push   $0x6e
  jmp alltraps
8010617d:	e9 75 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106184:	6a 6f                	push   $0x6f
  jmp alltraps
80106186:	e9 6c f7 ff ff       	jmp    801058f7 <alltraps>
...
8010618d:	6a 70                	push   $0x70
  jmp alltraps
8010618f:	e9 63 f7 ff ff       	jmp    801058f7 <alltraps>
...
80106196:	6a 71                	push   $0x71
  jmp alltraps
80106198:	e9 5a f7 ff ff       	jmp    801058f7 <alltraps>
...
8010619f:	6a 72                	push   $0x72
  jmp alltraps
801061a1:	e9 51 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061a8:	6a 73                	push   $0x73
  jmp alltraps
801061aa:	e9 48 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061b1:	6a 74                	push   $0x74
  jmp alltraps
801061b3:	e9 3f f7 ff ff       	jmp    801058f7 <alltraps>
...
801061ba:	6a 75                	push   $0x75
  jmp alltraps
801061bc:	e9 36 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061c3:	6a 76                	push   $0x76
  jmp alltraps
801061c5:	e9 2d f7 ff ff       	jmp    801058f7 <alltraps>
...
801061cc:	6a 77                	push   $0x77
  jmp alltraps
801061ce:	e9 24 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061d5:	6a 78                	push   $0x78
  jmp alltraps
801061d7:	e9 1b f7 ff ff       	jmp    801058f7 <alltraps>
...
801061de:	6a 79                	push   $0x79
  jmp alltraps
801061e0:	e9 12 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061e7:	6a 7a                	push   $0x7a
  jmp alltraps
801061e9:	e9 09 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061f0:	6a 7b                	push   $0x7b
  jmp alltraps
801061f2:	e9 00 f7 ff ff       	jmp    801058f7 <alltraps>
...
801061f9:	6a 7c                	push   $0x7c
  jmp alltraps
801061fb:	e9 f7 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106202:	6a 7d                	push   $0x7d
  jmp alltraps
80106204:	e9 ee f6 ff ff       	jmp    801058f7 <alltraps>
...
80106214:	6a 7f                	push   $0x7f
  jmp alltraps
80106216:	e9 dc f6 ff ff       	jmp    801058f7 <alltraps>
...
8010621d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106222:	e9 d0 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106235:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010623a:	e9 b8 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106241:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106246:	e9 ac f6 ff ff       	jmp    801058f7 <alltraps>
...
8010687a:	e8 41 de ff ff       	call   801046c0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a74:	a1 a4 6a 11 80       	mov    0x80116aa4,%eax
...
80106ab8:	0f 84 c2 00 00 00    	je     80106b80 <switchuvm+0xf0>
  pushcli();
80106abe:	e8 ed d9 ff ff       	call   801044b0 <pushcli>
...
80106b6d:	5d                   	pop    %ebp
  popcli();
80106b6e:	e9 8d d9 ff ff       	jmp    80104500 <popcli>
...
80106bd3:	e8 e8 da ff ff       	call   801046c0 <memset>
...
80106c06:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c07:	e9 54 db ff ff       	jmp    80104760 <memmove>
...
80106d3b:	e8 80 d9 ff ff       	call   801046c0 <memset>
...
80106ef4:	e8 c7 d7 ff ff       	call   801046c0 <memset>
...
80106f5f:	a3 a4 6a 11 80       	mov    %eax,0x80116aa4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010710e:	e8 4d d6 ff ff       	call   80104760 <memmove>
    len -= n;
    buf += n;
